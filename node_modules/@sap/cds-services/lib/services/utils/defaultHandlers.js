...
const _getDraftEnabledEntityHandlersOnlyAnnot = isRoot => {
  return new Map([
    ...
    [
      ...
      {
        before: new Map([
          ['NEW', ['beforeCreateDraft', 'beforeDefaultValuesKeys']],
...
const _getDraftEnabledEntityHandlersCapabAnnot = isRoot => {
  return new Map([
    ...
    [
      'NotUpdatable',
      {
        before: new Map([
          ...BEFORE_DRAFT,
          ['NEW', ['beforeCreateDraft', 'beforeDefaultValuesKeys']],
          ['DELETE', 'beforeDeleteOrCancelDraft']
        ]),
        on: new Map([
          ...ON_DRAFT,
          ['NEW', 'onCreateDraft'],
    ...
    [
      'NotDeletable',
      {
        before: new Map([...BEFORE_DRAFT, ['NEW', ['beforeCreateDraft', 'beforeDefaultValuesKeys']]]),
        on: new Map([
          ...ON_DRAFT,
          ['NEW', 'onCreateDraft'],
          ...(isRoot ? [...PR_AC_DRAFT, ['EDIT', 'onDraftEdit']] : [])
...
const _getDefaultHandlersOnlyAnnot = isDraftEnabledService => {
  return new Map([
    ...
    [
      '@insertonly',
      {
        before: new Map([['CREATE', 'beforeDefaultValuesKeys'], ['UPDATE', 'beforeDefaultValuesKeys']]),
...
const _getDefaultHandlersCapabAnnot = isDraftEnabledService => {
  return new Map([
    [
      'NotInsertable',
      {
        before: new Map([['UPDATE', 'beforeDefaultValuesKeys']]),
        on: new Map([
    ...
    [
      'NotUpdatable',
      {
        before: new Map([['CREATE', 'beforeDefaultValuesKeys']]),
        on: new Map([
          ['READ', isDraftEnabledService ? 'onReadOverDraft' : 'onRead'],
          ['CREATE', 'onCreate'],
          ['DELETE', 'onDelete']
