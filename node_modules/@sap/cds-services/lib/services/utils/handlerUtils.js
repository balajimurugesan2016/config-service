...
const _flattenToOneAssociation = (element, entity, row, property, csn) => {
  if (element.is2one) {
    ...
    if (!element.on && _isValidToOne(targetEntity, row[property])) {
