if (global.cds) module['exports'] = global.cds; else {
    ...
    module.exports = Object.assign ( cds, {
        ...
        debug: (x='all', _prefix='[cds] -') => RegExp(`\\b(y|all|${x})\\b`) .test (process.env.DEBUG) && (
            (...args) => console.warn (_prefix, ...args) // eslint-disable-line
        ),
