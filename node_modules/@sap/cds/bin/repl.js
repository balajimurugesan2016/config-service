...
function repl (_, options={}) {
  ...
  function print (o) {
    ...
    if (!o._isQuery && 'then' in o && typeof o.then === 'function') {
      o.then (r => { if (r) {
        repl.context._ = r
    ...
    // o = require('./utils/format').install(o)
    //> NOTE: disabled that as it is pretty expensive and causes endless loops with e.g. require.cache
    let result = inspect(o, {colors, depth: 11})

    if (o._isQuery) result = result
