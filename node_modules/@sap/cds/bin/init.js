...
function _init(args, _options) {
  ...
  if (options.for && options.for.startsWith('vanilla')) {
    return _vanilla (args, options)
  }

  console.log(warn(`
*****************************************************************
The command 'cds init' has moved to library @sap/cds-dk.
Remove the global version of @sap/cds and reinstall @sap/cds-dk.

    npm uninstall -g @sap/cds

    npm install -g @sap/cds-dk

To find out more about the new features use
